    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          nutritionnel consommé depuis des siècles et reconnu aujourd'hui comme
          un super-aliment.
        </p>
      ...
      <Card className="bg-green-50 border-green-200">
        ...
        <CardContent className="space-y-3">
          <div className="grid md:grid-cols-2 gap-3">
            ...
            <div className="flex items-center gap-2">
              <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
              <span className="text-lg">Histoire et origines ancestrales</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
              <span className="text-lg">
            ...
            <div className="flex items-center gap-2">
              <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
              <span className="text-lg">Précautions et contre-indications</span>
            </div>
          </div>
      ...
      <section>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            subtropicaux, principalement en Afrique, Asie et Amérique centrale.
          </p>
        </div>
      ...
      <section>
        ...
        <div className="prose prose-lg max-w-none mb-6">
          <p className="text-lg text-gray-700 leading-relaxed">
            La spiruline est l'un des aliments les plus riches de la planète. Sa
            composition exceptionnelle explique pourquoi elle est considérée
            comme un <strong>super-aliment complet</strong>.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="bg-purple-50 border-purple-200">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-purple-600 mb-2">B12</div>
              <p className="text-sm text-gray-700">
      ...
      <section>
        ...
        <div className="prose prose-lg max-w-none mb-6">
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            <strong>scientifiquement documentés</strong>. Voici les principales
            actions sur votre organisme :
          </p>
        </div>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-blue-50 border-blue-200">
            <CardHeader>
              <CardTitle className="text-blue-800">Dosage recommandé</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600">= 2g de spiruline pure</p>
              </div>
              <div>
      ...
      <section>
        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-700">
                ...
                Elle soutient la santé générale mais ne peut pas diagnostiquer,
                traiter ou guérir des maladies. Consultez toujours un médecin
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-700">
                Oui, la spiruline est 100% végétale et convient parfaitement aux
                végétariens et végans. Elle est même recommandée pour compléter
                leur apport en protéines et vitamine B12.
              </p>
            </CardContent>
          </Card>
      ...
      <section>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            renforcer votre système immunitaire ou optimiser votre nutrition, la
            spiruline peut être un excellent complément à une alimentation
