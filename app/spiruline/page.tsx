...
export const metadata = generateSEOMetadata({
  title:
    "Spiruline : Guide Complet 2025 - Bienfaits, Composition et Conseils d'Experts",
  description:
    "Découvrez la spiruline : bienfaits scientifiquement prouvés, conseils pour choisir une spiruline de qualité. Guide expert 20258.",
  keywords: [
    "spiruline",
    "bienfaits spiruline",
    "spiruline fer",
  ...
  ogImage: "/images/spiruline-guide-complet.jpg",
...
export default function SpirulnePage() {
  ...
  const articleSchema = generateArticleSchema({
    title: "Spiruline : Guide Complet pour une Santé Optimale",
    excerpt:
      "Découvrez tout ce qu'il faut savoir sur la spiruline : bienfaits scientifiquement prouvés, composition exceptionnelle et conseils d'experts pour choisir le meilleur produit.",
    datePublished: "2024-01-15",
    author: "Thibaut",
    category: "Guides Santé",
    url: "spiruline",
  });
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <section className="mb-12">
            ...
            <div className="prose prose-lg text-gray-700 mb-8">
              ...
              <p className="text-lg leading-relaxed mb-6">
                Reconnue par l'OMS comme <strong>"l'aliment du futur"</strong>,
                la spiruline est un véritable concentré de nutriments
                essentiels. Elle contient jusqu'à 70% de protéines complètes,
                dépassant ainsi la plupart des sources alimentaires
                traditionnelles.
              </p>
            </div>
          ...
          <section className="mb-12">
            ...
            <Card className="mb-8">
              <CardContent className="p-6 text-lg">
                <p className="mb-4">
                  La spiruline se présente sous différentes formes, chacune
                  ayant ses avantages :
                </p>
            ...
            <Card className="border-green-200 bg-gradient-to-br from-green-50 to-blue-50">
              <CardHeader>
                ...
                <CardDescription className="text-lg text-gray-700">
                  Spiruline premium cultivée en photobioréacteurs fermés pour
                  une pureté maximale
                </CardDescription>
              </CardHeader>
              <CardContent className="text-lg">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card>
                ...
                <CardContent className="text-lg">
                  <p className="mb-4">
                    <strong>Dosage recommandé :</strong> 4 comprimés par jour
                    (2g de spiruline) à prendre avec un verre d'eau, de
                    préférence le matin.
                  </p>
                  <p className="mb-4">
              ...
              <Card>
                ...
                <CardContent className="text-lg">
                  ...
                  <p>
                    La régularité est la clé pour observer des résultats
                    durables sur l'énergie et l'immunité.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="border-green-200 bg-green-50">
              ...
              <CardContent className="text-lg">
                ...
                <p className="mb-6">
                  ...
                  <strong>photobioréacteurs fermés</strong>, riche en
                  phycocyanine et certifiée. Les comprimés restent le format le
                  plus pratique pour un dosage précis et une conservation
                  optimale.
                </p>
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <ol className="text-sm text-gray-600 space-y-1">
                ...
                <li>
                  2. Étude scientifique sur la phycocyanine, Journal of
                  Medicinal Food, 2019.
                </li>
                <li>
                  3. « La spiruline : bienfaits et usages », Université de
                  Paris, 2021.
                </li>
                <li>
