    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p className="text-lg text-gray-700">
          Dans ce guide complet, vous découvrirez la composition détaillée de la
          spiruline, comprendre pourquoi elle surpasse la plupart des autres
          sources nutritionnelles, et comment choisir une spiruline de qualité
              ...
              <tbody className="divide-y">
                {nutritionalData.map((item, index) => (
                  <tr key={index} className="hover:bg-gray-50 text-lg">
                    ...
                    <td className="px-6 py-4 font-semibold">{item.quantite}</td>
                    <td className="px-6 py-4 text-gray-700">{item.benefice}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <Card className="border-red-200 bg-red-50">
        ...
        <CardContent className="text-lg space-y-4">
          ...
          <p className="text-red-700 font-medium">
            💡 <strong>Astuce :</strong> Associez votre spiruline à des aliments
            riches en vitamine C (agrumes, kiwi) pour optimiser l'absorption du
            fer !
          </p>
        </CardContent>
      </Card>
      ...
      <div className="space-y-6">
              ...
              <CardContent className="p-4">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">{vitamin.benefice}</p>
                  </div>
        ...
        <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
          ...
          <p className="text-lg">
            ...
            (provitamine A) que les carottes ! Une seule cuillère à café couvre
            100% de vos besoins quotidiens en vitamine A.
          </p>
        </div>
      </div>
      ...
      <Card className="border-indigo-200 bg-gradient-to-r from-indigo-50 to-blue-50">
        ...
        <CardContent className="text-lg space-y-4">
          <p>
            ...
            donne sa couleur à la spiruline. Cette protéine représente 15-20% du
            poids sec et possède des propriétés antioxydantes exceptionnelles.
          </p>
          ...
          <Card className="border-teal-200">
            ...
            <CardContent className="text-lg">
              ...
              <p className="mt-4 text-teal-700 font-medium">
                Une biodisponibilité optimale grâce à la structure cellulaire de
                la spiruline
              </p>
            </CardContent>
          </Card>
      ...
      <Card className="border-2 border-green-300 bg-gradient-to-r from-green-50 to-blue-50">
        ...
        <CardContent className="text-lg space-y-4">
          <p>
            ...
            de dernière génération, garantissant une composition optimale et une
            pureté inégalée.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  <AlertTriangle className="h-4 w-4 text-red-600 mr-2 mt-1 flex-shrink-0" />
                  <span>Traitement anticoagulant (interactions possibles)</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="bg-white p-4 rounded-lg border border-red-200 mt-4">
                <p className="font-medium text-red-700">
                  ⚠️ <strong>Important :</strong> Consultez votre médecin avant
                  utilisation si vous êtes enceinte, allaitante ou sous
                  traitement médical.
                </p>
              </div>
            </div>
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg text-gray-700">
          Pour mieux comprendre l'exceptionnelle richesse de la spiruline, voici
          comment elle se compare aux autres sources nutritionnelles populaires
          :
        </p>
          ...
          <table className="w-full border border-gray-200 rounded-lg">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-semibold">Protéines</th>
                <th className="px-4 py-3 text-left font-semibold">
                  Fer (mg/100g)
                </th>
                <th className="px-4 py-3 text-left font-semibold">
        ...
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
          ...
          <p className="text-lg">
            ...
            (3g) de spiruline apporte autant de protéines que 30g de viande, 10x
            plus de bêta-carotène que les carottes, et des antioxydants uniques
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span>
                    <strong>Espèce :</strong> Spirulina maxima (27% de protéines
                    en plus)
                  </span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-4 w-4 text-purple-600 mr-2 mt-1" />
                  <span>
                    <strong>Séchage :</strong> Basse température pour préserver
                    les nutriments
                  </span>
                </li>
                <li className="flex items-start">
      ...
      <div className="space-y-6">
        ...
        <div className="prose prose-lg max-w-none text-lg space-y-4">
          <p>
            La spiruline mérite pleinement son titre de "super-aliment" grâce à
          ...
          <div className="bg-green-50 p-6 rounded-lg border border-green-200">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span>
                  <strong>Pour qui :</strong> Idéale pour végétariens, sportifs,
                  seniors et toute personne souhaitant optimiser son apport
                  nutritionnel
                </span>
              </li>
              <li className="flex items-center">
      ...
      <div className="bg-gray-50 p-6 rounded-lg border">
        ...
        <div className="text-sm text-gray-600 space-y-2">
          <p>
            ...
            evidence-based human applications." Evidence-Based Complementary and
            Alternative Medicine.
          </p>
          <p>
            2. Wu, Q., et al. (2016). "The antioxidant, immunomodulatory, and
            anti-inflammatory activities of Spirulina." Annals of Nutrition and
            Metabolism.
          </p>
          <p>
            3. Finamore, A., et al. (2017). "Antioxidant, immunomodulating, and
            microbial-modulating activities of the sustainable and ecofriendly
            spirulina." Oxidative Medicine and Cellular Longevity.
          </p>
          <p>
